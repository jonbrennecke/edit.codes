...
def WaitForOperations(operations, project, operation_service, resource_service,
                      ...
                      custom_get_requests=None, timeout=None, now=None):
  ...
  Args:
    ...
    now: A function that can tell time, in seconds. This is used for
      testing.
  ...
  while operations:
    ...
    time.sleep(min(sleep_sec, _MAX_TIME_BETWEEN_POLLS_SEC))
